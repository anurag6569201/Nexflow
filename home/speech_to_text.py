...
SUBSCRIPTION_KEY = os.getenv('SPEECH_TO_TEXT_RESOURCE_KEY')
SERVICE_REGION = os.getenv('SPEECH_TO_TEXT_SERVICE_REGION')
...
def transcribe(RECORDINGS_BLOB_URI):
    ...
    properties.language_identification = swagger_client.LanguageIdentificationProperties(mode="continuous", candidate_locales=["en-US", "hi-IN"])
